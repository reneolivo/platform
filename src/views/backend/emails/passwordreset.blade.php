...
<a href='{{{ (Confide::checkAction('\\Thor\\Admin\\AuthController@reset_password', array($token))) ? : Admin::url('auth/reset_password/'.$token)  }}}'>
    {{{ (Confide::checkAction('\\Thor\\Admin\\AuthController@reset_password', array($token))) ? : Admin::url('auth/reset_password/'.$token)  }}}
</a>
